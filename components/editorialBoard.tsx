            ...
            <div className="px-4 py-8 space-y-12">
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    <div className="bg-[#003366] p-4 text-center">
                        <h2 className="text-xl font-bold text-white">Head of Editorial Board</h2>
                    </div>
                    <div className="p-6">
                        <h3 className="text-2xl font-bold text-[#003366] mb-2">Muhammad Saeed</h3>
                ...
                {/* Member Editorial Board - Ashfaq Malik */}
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    <div className="bg-[#003366] p-4 text-center">
                        <h2 className="text-xl font-bold text-white">Member Editorial Board</h2>
                    </div>
                    <div className="p-6">
                        <h3 className="text-2xl font-bold text-[#003366] mb-2">Ashfaq Malik</h3>
                        <p className="text-gray-700 mb-4">
                ...
                {/* Member Editorial Board - Shahzad Saleem */}
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    <div className="bg-[#003366] p-4 text-center">
                        <h2 className="text-xl font-bold text-white">Member Editorial Board</h2>
                    </div>
                    <div className="p-6">
                        <h3 className="text-2xl font-bold text-[#003366] mb-2">Shahzad Saleem</h3>
                        <p className="text-gray-700 mb-4">
                            Shahzad Saleem is an Assistant Professor at College of Computer Science and Engineering, University of Jeddah, KSA. He also serves as head of the Department of Information Security. KTH-AIS Lab, School of Electrical Engineering and Computer Science, NUST, the top university of Pakistan.
                        </p>
                        <p className="text-gray-700 mb-4">
                            He has over fourteen years of teaching research and industry experience in various executive positions. He has been involved in more than twenty research publications indexed by Scopus. Right now, he is co-authoring a research proposal of US$400,000 under Pak-China Research Grant. The areas of research that interest him include Digital Forensics, Authentication and Access Controls.
                        </p>
                        <p className="text-gray-700">
                ...
                {/* Member Editorial Board - Adnan Masood */}
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    <div className="bg-[#003366] p-4 text-center">
                        <h2 className="text-xl font-bold text-white">Member Editorial Board</h2>
                    </div>
                ...
                {/* Member Editorial Board - S. Irfan Nabi */}
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    <div className="bg-[#003366] p-4">
                        <h2 className="text-xl font-bold text-white">Member Editorial Board</h2>
                    </div>
                    <div className="p-6">
                        <h3 className="text-2xl font-bold text-[#003366] mb-2">S. Irfan Nabi</h3>
                        <p className="text-gray-700">
